<template>
    <section class="programs__page">
        ...
        <Head text="Students Registration" subtitle="/ Students Registration" />
...
<style scoped>
.students-reg-list {
    grid-template-columns: 1.1fr 1.8fr 0.8fr 0.8fr 1fr 0.8fr 0.5fr;
}
...
.main__all-text select:not([multiple]) {
    padding-right: 1.8em;
